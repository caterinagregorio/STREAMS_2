...
#'   }
#'@param varmethod character indication type of variance calculation: "rubin" or "jackknife"
...
)
{
  ...
  pooled_fit <- pool_rubin_all_transitions(all_fits, cl = 0.95, distribution, clock_assumption, cov_vector, custom_formula, loss_plots, logs_cols,varmethod=varmethod)
